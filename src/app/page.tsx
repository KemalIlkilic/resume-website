...
function EducationIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 14 14" aria-hidden="true" {...props} fill="currentColor">
...
function EducationItem({ education }: { education: Education }) {
  ...
  let startDate =
    typeof education.start === 'string'
      ? education.start
      : education.start.dateTime
  let startMonth =
    typeof education.start === 'string' ? '' : education.start.month

  let endLabel =
    typeof education.end === 'string' ? education.end : education.end.label
  let endDate =
    typeof education.end === 'string' ? education.end : education.end.dateTime
  let endMonth = typeof education.end === 'string' ? '' : education.end.month
  ...
  let education: Array<Education> = [
    {
      ...
      location: '%100 Scholarship',
      start: '2020',
      end: '2025',
      details: 'Istanbul, Turkey',
    },
    {
      school: 'Ziraat Bankası Balıkesir Fen Lisesi',
      degree: 'High School',
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software engineer, student and amateur chess player
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Kemal, a software engineer based in Istanbul. I specialize in
            building innovative and scalable software solutions. Passionate
            about problem-solving, I develop technology that enhances everyday
            life and pushes the boundaries of what’s possible.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/KemalIlkilic"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/kemalilkilic/"
